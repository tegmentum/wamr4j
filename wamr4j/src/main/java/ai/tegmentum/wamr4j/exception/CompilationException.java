 ...
 *
 * <p>This exception is thrown when the WebAssembly runtime encounters errors during the compilation
 * phase, such as invalid bytecode, unsupported features, or malformed WebAssembly modules.
 *
 * @since 1.0.0
 */
public class CompilationException extends WebAssemblyException {
    ...
    /**
     * Constructs a new compilation exception with the specified cause and a detail message of
